          ...
          <div className={styles.navFill}>
            {segment === "home" ? (
              ...
              <>
                ...
                <div className={styles.navFillDiv}>홈</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={styles.navFill}>
            {segment && ["search", "explore"].includes(segment) ? (
              ...
              <>
                ...
                <div className={styles.navFillDiv}>탐색하기</div>
              </>
            )}
          </div>
        </Link>
          ...
          <div className={styles.navFill}>
            {segment === "messages" ? (
              ...
              <>
                ...
                <div className={styles.navFillDiv}>쪽지</div>
              </>
            )}
          </div>
        </Link>
            ...
            <div className={styles.navFill}>
              {segment === me.id ? (
                ...
                <>
                  ...
                  <div className={styles.navFillDiv}>프로필</div>
                </>
              )}
            </div>
          </Link>
